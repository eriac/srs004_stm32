#ifndef _ROS_s4_msgs_NavigatorTargetCommand_h
#define _ROS_s4_msgs_NavigatorTargetCommand_h
...
namespace s4_msgs
{
  ...
  class NavigatorTargetCommand : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "s4_msgs/NavigatorTargetCommand"; };
